...
from dosedynamics.config import PlottingConfig, ThigmotaxisConfig


class ThigmotaxisPlotter:
    def __init__(self, plot_cfg: PlottingConfig, thig_cfg: ThigmotaxisConfig) -> None:
        self.plot_cfg = plot_cfg
        self.thig_cfg = thig_cfg
